    ...
    <div id="app">
        ...
        <div>
            <div class="form-group">
                <input id="name" type="text" class="form-control" placeholder="请输入商家名称" maxlength="10">
            </div>
            <div class="form-group">
                <input id="address" type="text" class="form-control" placeholder="请输入商家地址" maxlength="10">
            </div>
            <div class="form-group">
                <input id="idNumber" type="text" class="form-control" placeholder="请输入营业人身份证号" maxlength="10">
            </div>
            <div class="form-group">
...
<script>
    ...
    oRegister.onclick = function () {
        ...
        {
            var oName = $(".name").val();       //name,address,idNumber,account,password1,password2
